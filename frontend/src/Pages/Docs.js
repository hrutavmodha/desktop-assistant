...
import P from "../Components/Pages"
  ...
  return (
    <div className="max-w-3xl mx-auto py-10 px-4 space-y-6">
      ...
      <P>
        ...
        1. Download your OS-specific executable from the <a className="text-blue-600 underline" href="/download">here</a><br />
        2. Run it. First time launch will auto-download necessary models.<br />
        3. Use the "Give Command" button to speak your query.
      </P>
      <P>
        For full API details and 
        contribution guidelines, check out the 
        <a className="text-blue-600 underline" 
        href="https://github.com/hrutavmodha/voice-assistant" 
        target="_blank" 
        rel="noreferrer">
